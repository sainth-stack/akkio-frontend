                    ...
                    <Col xs={24} sm={12} lg={8} key={index}>
                        <Card
                            ...
                            style={{
                                ...
                                backgroundColor: selectedKpiNames.includes(kpi['KPI Name']) ? '#f0f7ff' : 'white',
                                border: selectedKpiNames.includes(kpi['KPI Name']) ? '1px solid #1890ff' : '1px solid #f0f0f0',
                                cursor: 'pointer',
                            }}
                            bodyStyle={{
                                padding: '20px',
                        ...
                        >
                            <Title level={4} style={{
                                ...
                                KPI Name: {kpi['KPI Name'].charAt(0).toUpperCase() + kpi['KPI Name'].slice(1)}
                            </Title>
